...
<form action="?pg=personagem-cadastro" method="post">
    ...
    <label>Força:</label>
    <input type="text" name="forca"><br>
    <label>Destreza:</label>
    <input type="text" name="destreza"><br>
    <label>Constituição:</label>
    <input type="text" name="constituicao"><br>
    <label>Inteligência:</label>
    <input type="text" name="inteligencia"><br>
    <label>Sabedoria:</label>
    <input type="text" name="sabedoria"><br>
    <label>Carisma:</label>
    <input type="text" name="carisma"><br>
